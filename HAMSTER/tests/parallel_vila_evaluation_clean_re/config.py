"""
Configuration for parallel VILA path generation - Evaluation Tasks (Clean).
"""
...
# ============================================================
NUM_GPUS = 4
BASE_PORT = 8008  # Ports will be 8008, 8009, 8010, 8011
...
# Results directory - Clean evaluation data
RESULTS_DIR = HAMSTER_DIR / "results" / "evaluation_tasks_clean"
