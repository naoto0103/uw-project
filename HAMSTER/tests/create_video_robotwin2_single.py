#!/usr/bin/env python3
"""
Create visualization videos for RoboTwin 2.0 single-arm path generation results.

Phase 3.6 Stage 3 - Visualize single-arm paths and create MP4 videos.
...
Works with paths generated by generate_paths_robotwin2_single.py (VERSION 18, <ans> tag format)
"""
...
def visualize_and_create_video(
    ...
    for i, frame_file in enumerate(frame_files):
        ...
        if path_file.exists():
            ...
            # Draw path on frame (single-arm format: List[Tuple])
            frame_with_path = draw_single_path_on_image(frame, path)
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create visualization videos for RoboTwin 2.0 single-arm paths"
    )
    ...
    print("=" * 80)
    print("RoboTwin 2.0 Single-Arm Video Creation (VERSION 18)")
    print("=" * 80)
