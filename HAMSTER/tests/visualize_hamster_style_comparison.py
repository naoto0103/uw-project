...
def main():
    ...
    # VERSION 6: qwen3_path_file = ".../qwen3_unchanged_state_path.pkl"
    # VERSION 7: qwen3_path_file = ".../qwen3_test_path.pkl"  # HAMSTER-style prompt (same as VILA)
    # VERSION 8: qwen3_path_file = ".../qwen3_test_path.pkl"  # HAMSTER-style prompt + VILA system message
    # VERSION 9: qwen3_path_file = ".../qwen3_test_path.pkl"  # + Robot trajectory specialized system prompt
    # VERSION 10: qwen3_path_file = ".../qwen3_test_path.pkl"  # 0~1000 coordinate system
    # VERSION 11: qwen3_path_file = ".../qwen3_v11_intermediate_waypoints_path.pkl"  # + Intermediate waypoints instruction
    # VERSION 12: qwen3_path_file = ".../qwen3_v12_simplified_examples_path.pkl"  # prompt_type: 'simplified_examples' (2 waypoints example instead of 6)
    # VERSION 13: qwen3_path_file = ".../qwen3_v13_vila_style_concise_path.pkl"  # prompt_type: 'vila_style_concise' (VILA-style expression, no trajectory list)
    # VERSION 14: qwen3_path_file = ".../qwen3_v14_vila_style_with_requirements_path.pkl"  # prompt_type: 'vila_style_with_requirements' (VILA-style + trajectory requirements)
    # VERSION 15: qwen3_path_file = ".../qwen3_v15_vila_style_gripper_only_path.pkl"  # prompt_type: 'vila_style_gripper_only' (no trajectory list, gripper desc integrated)
    # VERSION 16: qwen3_path_file = ".../qwen3_v16_hamster_format_no_system_path.pkl"  # prompt_type: 'hamster_format_no_system' (VERSION 10 format, no system prompt)
    # VERSION 17: qwen3_path_file = ".../qwen3_v17_hamster_modified_example_path.pkl"  # prompt_type: 'hamster_modified_example' (modified example coords)
    # VERSION 18: qwen3_path_file = ".../qwen3_v18_hamster_final_coord_190_711_path.pkl"  # prompt_type: 'hamster_final_coord_190_711' (final coord 190,711)
    qwen3_path_file = "/home/naoto/HAMSTER-ManiFlow-Integration/HAMSTER/results/qwen3_v18_hamster_final_coord_190_711_path.pkl"
    ...
    # VERSION 6: output_path = ".../unchanged_state_comparison.png"
    # VERSION 7: output_path = ".../hamster_style_comparison.png"
    # VERSION 8: output_path = ".../vila_system_prompt_comparison.png"
    # VERSION 9: output_path = ".../robot_specialized_system_prompt_comparison.png"
    # VERSION 10: output_path = ".../qwen3_0_1000_coords_comparison.png"
    # VERSION 11: output_path = ".../qwen3_intermediate_waypoints_comparison.png"
    # VERSION 12: output_path = ".../qwen3_v12_simplified_examples_comparison.png"
    # VERSION 13: output_path = ".../qwen3_v13_vila_style_concise_comparison.png"
    # VERSION 14: output_path = ".../qwen3_v14_vila_style_with_requirements_comparison.png"
    # VERSION 15: output_path = ".../qwen3_v15_vila_style_gripper_only_comparison.png"
    # VERSION 16: output_path = ".../qwen3_v16_hamster_format_no_system_comparison.png"
    # VERSION 17: output_path = ".../qwen3_v17_hamster_modified_example_comparison.png"
    # VERSION 18: output_path = ".../qwen3_v18_hamster_final_coord_190_711_comparison.png"
    output_path = "/home/naoto/HAMSTER-ManiFlow-Integration/HAMSTER/results/visualizations/qwen3_v18_hamster_final_coord_190_711_comparison.png"
