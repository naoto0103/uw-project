...
class ManiFlowTransformerPointcloudPolicy(BasePolicy):
    def __init__(self, 
            ...
            # HAMSTER path encoder parameters
            path_hidden_dim=128,
            path_output_dim=256,
            path_num_heads=4,
            path_num_layers=2,
        ...
        if encoder_type == "DP3Encoder":
            ...
            obs_encoder = HAMSTERPathDP3Encoder(
                ...
                path_output_dim=path_output_dim,
                path_num_heads=path_num_heads,
                path_num_layers=path_num_layers,
            )
        else:
